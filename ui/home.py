...
"}")
        ...
        self.logo.setStyleSheet(u"image: url(:/all/img/LOGO1.png);\n"
...
"}")
        ...
        self.src_home_button = QPushButton(self.MenuBox)
        self.src_home_button.setObjectName(u"src_home_button")
        ...
        self.src_home_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.src_home_button.setStyleSheet(u"QPushButton{\n"
"background-image: url(:/all/img/home.png);\n"
"background-repeat: no-repeat;\n"
"background-position: left center;\n"
"border: none;\n"
"border-left: 23px solid transparent;\n"
...
"background-color: rgba(114, 129, 214, 59);\n"
"}")
        self.src_home_button.setIconSize(QSize(16, 16))

        self.verticalLayout_5.addWidget(self.src_home_button)
...
"")
        ...
        self.verticalLayout_14.addWidget(self.Model_name, 0, Qt.AlignmentFlag.AlignTop)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.pushButton_detect, 0, 0, 1, 1)
        ...
        self.pushButton_segment.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.pushButton_segment, 1, 0, 1, 1)
        ...
        self.pushButton_track = QPushButton(self.home)
...
"background-color: rgba(114, 129, 214, 59);\n"
"}")
        self.pushButton_track.setIconSize(QSize(300, 300))

        self.gridLayout_4.addWidget(self.pushButton_track, 0, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_4.addWidget(self.pushButton_pose, 1, 0, 1, 1)
...
"}")
        ...
        self.horizontalLayout_41.addWidget(self.pushButton_classify)
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.verticalLayout_27.addWidget(self.fps_label_cam, 0, Qt.AlignmentFlag.AlignTop)
...
"}\n"
"")
        self.Model_QF_cam.setFrameShape(QFrame.Shape.StyledPanel)
        self.Model_QF_cam.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.Model_top_cam.setFrameShape(QFrame.Shape.StyledPanel)
        self.Model_top_cam.setFrameShadow(QFrame.Shadow.Raised)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.Model_bottom_cam.setFrameShape(QFrame.Shape.StyledPanel)
        self.Model_bottom_cam.setFrameShadow(QFrame.Shadow.Raised)
...
"font: 15pt \"Microsoft YaHei UI\";\n"
"")
        self.Model_name_cam.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_29.addWidget(self.Model_name_cam, 0, Qt.AlignmentFlag.AlignTop)
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Use Model", None))
